...
class RankHandler(RequestHandler):
    ...
    async def get(self, pro_id):
        ...
        #TODO: ASC的"challenge"."acct_id"重複了
        # result = await self.db.fetch(
        #     '''
        #         SELECT * FROM (
        #         SELECT DISTINCT ON ("challenge"."acct_id")
        #         "challenge"."chal_id", "challenge"."acct_id",
        #         "challenge"."timestamp", "account"."name" AS "acct_name",
        #         "challenge_state"."runtime", "challenge_state"."memory",
        #         FROM "challenge"
        #         INNER JOIN "account"
        #         ON "challenge"."acct_id" = "account"."acct_id"
        #         LEFT JOIN "challenge_state"
        #         ON "challenge"."chal_id" = "challenge_state"."chal_id"
        #         WHERE "account"."acct_type" >= $1 AND "challenge"."pro_id" = $2 AND "challenge_state"."state" = 1
        #         ORDER BY "challenge"."acct_id" ASC, "challenge_state"."runtime" ASC, "challenge_state"."memory" ASC,
