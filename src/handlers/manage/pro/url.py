...
from handlers.manage.pro.general import ManageProListHandler
from handlers.manage.pro.add import ManageProAddHandler
from handlers.manage.pro.update import ManageProUpdateHandler
...
def get_manage_pro_url():
    ...
    return [
        ...
        ('/be/manage/pro/update', ManageProUpdateHandler),
