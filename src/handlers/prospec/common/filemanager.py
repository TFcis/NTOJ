...
filemanager_dispatcher = ActionDispatcher()


class ProblemFilemanagerHandler(RequestHandler):
    @reqenv
    ...
    async def _handle_download(self, pro_id, pro):
        ...
        allowed_paths = self.spec.get_allowed_file_paths(spec_config, pro_id)
    ...
    @filemanager_dispatcher.action('renamesinglefile')
    ...
    @filemanager_dispatcher.action('updatesinglefile')
    ...
    @filemanager_dispatcher.action('addsinglefile')
    ...
    @filemanager_dispatcher.action('deletesinglefile')
    ...
    async def post(self):
        ...
        return await filemanager_dispatcher.dispatch(self, reqtype)
